...
@Controller
@RequestMapping("/admin_memCheck")
public class Admin_memCheck {
	...
	public ModelAndView getadminList(HttpSession session, HttpServletRequest request) {
		...
		ModelAndView mav = new ModelAndView("admin_main_page", "adminlist", adminlist);
		mav.setViewName("admin_memCheck");
		mav.addObject("admin_memCheck", adminlist);
		return mav;
	}
}
