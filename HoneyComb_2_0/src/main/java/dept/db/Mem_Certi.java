...
public class Mem_Certi {
	...
	public Mem_Certi(int mem_num, int certi_num, String certi_name, String certi_insti, String certi_date) {
		super();
	...
	public String toString() {
		return "Mem_Certi [mem_num=" + mem_num + ", certi_num=" + certi_num + ", certi_name=" + certi_name
				+ ", certi_insti=" + certi_insti + ", certi_date=" + certi_date + "]";
	}
