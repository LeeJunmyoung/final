...
<body>
	<script type="text/javascript">
		...
		function testAPI() {
			...
			FB.api('/me', {
				...
				window.location.replace("login/apiLogIn.do?email=" + email
				...
				<div class="col-md-12 text-center" id="col-md-12">
					...
					<form class="form-horizontal text-center" method="post"
						...
						<div id="buttoncheck">
							...
							<br>
							<fb:login-button data-size="large" scope="public_profile,email"
								onlogin="checkLoginState();">Facebook 아이디로 로그인</fb:login-button>
							<br>
							<!-- 네이버아이디로로그인 버튼 노출 영역 -->
	...
	<script type="text/javascript">
		var naver_id_login = new naver_id_login("XxuZWIw4L8tP4C_0BW1_",
				"http://112.220.63.3:8180/HoneyComb_2_0/login/logIn.do");
		...
		function naverSignInCallback() {
			...
			window.opener.location.replace("login/apiLogIn.do?email=" + email
					+ "&gender=" + gender + "&name=" + name);
			window.close();
