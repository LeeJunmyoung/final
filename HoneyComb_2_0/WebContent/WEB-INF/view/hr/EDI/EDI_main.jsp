		...
		<div class="row">
			...
			<div class="col-md-11">
				...
				<table class="table table-hover">
					...
					<tbody>
						<c:if test="${not empty EDI_Table  }">
							<c:forEach var="EDI_Table" items="${EDI_Table }">
								<tr>
									<th class="col-md-2 text-center">${EDI_Table.document_num }</th>
									<th class="col-md-4">${EDI_Table.EDI_Subject }</th>
									<th class="col-md-2 text-center">${EDI_Table.document_num }</th>
									<th class="col-md-2 text-center">${EDI_Table.document_num }</th>
									<th class="col-md-3 text-center">${EDI_Table.document_num }</th>
								</tr>
						...
						<tr>
							...
							<th class="col-md-2 text-center">01-01</th>
							<th class="col-md-4">제목 테스트</th>
