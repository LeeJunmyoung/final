		...
		<c:if test="${ !empty noticelist }">
			<c:forEach var="noticelist" items="${ noticelist }">
				...
				<table width="320" border="1" bordercolor="#cccccc" align="center"
					...
					<tr>
						<td align="center">${noticelist.notice_admin_title}</td>
					</tr>
					<tr>
						<td align="center" colspan="2">${noticelist.notice_admin_content }</td>
					</tr>
				</table>
				<p align="center">
					<font size="1">작성일 ${noticelist.notice_admin_date }</font>
				</p>
			</c:forEach>
		</c:if>
