		...
		<form>
			<table width="400" border="1" cellpadding="1" cellspacing="0">
				<c:forEach var="adminlist" items="${adminlist}">
					...
					<tr>
						<td width="300" align="center">${adminlist.com_name}</td>
						<td width="300" align="center">${adminlist.com_add}</td>
						<td width="300" align="center">${adminlist.com_aff}</td>
						<td width="300" align="center">${adminlist.com_phone}</td>
					</tr>
				</c:forEach>
			</table>
